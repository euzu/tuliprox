...
const LABEL_RECORDING_QUEUE: &str = "LABEL.RECORDING_QUEUE";
const LABEL_RETRY_BACKOFF_INITIAL: &str = "LABEL.RECORDING_RETRY_BACKOFF_INITIAL";
const LABEL_RETRY_BACKOFF_MULTIPLIER: &str = "LABEL.RECORDING_RETRY_BACKOFF_MULTIPLIER";
const LABEL_RETRY_BACKOFF_MAX: &str = "LABEL.RECORDING_RETRY_BACKOFF_MAX";
const LABEL_RETRY_BACKOFF_JITTER_PERCENT: &str = "LABEL.RECORDING_RETRY_BACKOFF_JITTER_PERCENT";
const LABEL_RETRY_MAX_ATTEMPTS: &str = "LABEL.RECORDING_RETRY_MAX_ATTEMPTS";
