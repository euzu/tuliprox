...
const LABEL_USE_DISK_INPUT_PLAYLIST: &str = "LABEL.USE_DISK_INPUT_PLAYLIST";
...
generate_form_reducer!(
    ...
    fields {
        ...
        UseDiskInputPlaylist => use_disk_input_playlist: bool,
...
pub fn MainConfigView() -> Html {
    ...
    let render_view_mode = || {
        html! {
            <>
                ...
                { config_field_bool!(form_state.form, translate.t(LABEL_USE_DISK_INPUT_PLAYLIST), use_disk_input_playlist) }
    ...
    let render_edit_mode = || html! {
        <>
            ...
            { edit_field_bool!(form_state, translate.t(LABEL_USE_DISK_INPUT_PLAYLIST), use_disk_input_playlist, MainConfigFormAction::UseDiskInputPlaylist) }
