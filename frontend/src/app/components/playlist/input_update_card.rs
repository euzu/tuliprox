...
mod tests {
    ...
    fn playlist_update_view_action_and_accessibility_translations_exist_in_every_frontend_locale(
        ...
        let pointers = [
            ...
            "/MESSAGES/PLAYLIST_UPDATE/DETAIL_INPUT_COMPLETED_PARTIALLY",
            "/MESSAGES/PLAYLIST_UPDATE/DETAIL_INPUT_COMPLETED_SUCCESSFULLY",
            "/MESSAGES/PLAYLIST_UPDATE/DETAIL_INPUT_FAILED",
            "/MESSAGES/PLAYLIST_UPDATE/DETAIL_LIBRARY_RESCAN_COMPLETED",
            "/MESSAGES/PLAYLIST_UPDATE/DETAIL_LIBRARY_RESCAN_FAILED",
            "/MESSAGES/PLAYLIST_UPDATE/DETAIL_LIBRARY_RESCAN_STARTED",
            "/MESSAGES/PLAYLIST_UPDATE/DETAIL_LIBRARY_SCAN_RESULT",
