           ...
           <div class="tp__stream-display__row">
            <div class="tp__stream-display__stats">
                    ...
                    <div class="tp__stream-display__stat tp__stream-display__stat--duration">
                        ...
                        <span class="tp__stream-display__stat-value tp__stream-display__duration" data-ts={stream.started_at.to_string()}>
                            {format_duration(current_time_secs().saturating_sub(stream.started_at))}
                        </span>
                    </div>
