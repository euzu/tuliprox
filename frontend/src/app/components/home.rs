                ...
                <div class="tp__app-main">
                    <div class="tp__app-main__header tp__app-header">
                        ...
                        <div class={"tp__app-header-toolbar"}>
                            <IconButton name="Theme" icon={if (*theme).is_light() {"Moon"} else {"Sun"}} hint={format!("Theme: {}", (*theme).label())} onclick={handle_theme_switch.clone()} />
                        ...
                        </div>
                        {
                            if setup_mode {
                                ...
                                html! {
                                    <div class={"tp__app-header-toolbar"}>
                                        <WebsocketStatus/>
                                        <IconButton name="Theme" icon={if (*theme).is_light() {"Moon"} else {"Sun"}} hint={format!("Theme: {}", (*theme).label())} onclick={handle_theme_switch} />
