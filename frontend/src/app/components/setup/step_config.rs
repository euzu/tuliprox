    ...
    app::{
        components::{
            config::{
                ...
                ProxyConfigView, RecordingConfigView, ReverseProxyConfigView, SchedulesConfigView, WebUiConfigView,
            },
...
fn render_config_page(step: SetupStep) -> Html {
    match step {
        ...
        SetupStep::Video => html! { <RecordingConfigView/> },
    ...
    let on_form_change = {
        ...
        Callback::from(move |form_data: ConfigForm| {
            ...
            let current_slot = match &form_data {
                ...
                ConfigForm::Recording(_, _) => setup_ctx.config_forms.slots.recording.as_ref(),
