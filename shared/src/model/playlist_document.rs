...
use crate::model::{
    ...
    XtreamCluster, XtreamEmptyDoc, XtreamInfoDocument, XtreamMappingFlags,
    XtreamMappingOptions, XtreamPlaylistItem,
...
impl XtreamPlaylistItem {
    ...
    fn live_to_document(&self, options: &XtreamMappingOptions, live: &LiveStreamProperties) -> XtreamDocument {
        ...
        XtreamDocument::Live(XtreamLiveDoc {
            ...
            direct_source: if options
                .flags
                .contains(XtreamMappingFlags::SkipLiveDirectSource)
            {
                empty_str
            } else {
