...
use crate::utils::{
    arc_str_default_on_null, arc_str_none_default_on_null, arc_str_option_serde,
    deserialize_as_option_arc_str, deserialize_as_string_array, deserialize_json_as_opt_string,
    deserialize_number_from_string, deserialize_number_from_string_or_zero,
    serialize_json_as_opt_string, serialize_option_string_as_null_if_empty, Internable,
};
use log::warn;
...
impl StreamProperties {
    ...
    pub fn get_release_date(&self) -> Option<Arc<str>> {
        match self {
            StreamProperties::Live(_) => None,
            StreamProperties::Video(video) => video
                .details
                .as_ref()
                .and_then(|d| d.release_date.as_ref().map(Arc::clone)),
    ...
    pub fn get_container_extension(&self) -> Option<Arc<str>> {
        match self {
            ...
            StreamProperties::Series(series) => series
                ...
                .and_then(|e| {
                    e.first()
                        .and_then(|e| non_empty_arc(&e.container_extension))
                }),
    ...
    pub fn get_last_modified(&self) -> Option<u64> {
        match self {
            ...
            StreamProperties::Episode(episode) => {
                episode.added.as_ref().and_then(|v| v.parse::<u64>().ok())
            }
        }
    }
    ...
    fn from_info_base(info: &XtreamVideoInfo) -> VideoStreamProperties {
        VideoStreamProperties {
            ...
            stream_icon: info
                ...
                .movie_image
                .as_ref()
                .map_or_else(|| "".intern(), Clone::clone),
