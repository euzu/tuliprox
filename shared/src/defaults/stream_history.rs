...
pub fn default_stream_history_batch_size() -> usize {
    DEFAULT_STREAM_HISTORY_BATCH_SIZE
}
pub fn default_stream_history_retention_days() -> u16 {
    DEFAULT_STREAM_HISTORY_RETENTION_DAYS
}
pub fn default_stream_history_directory() -> String {
    DEFAULT_STREAM_HISTORY_DIR.to_string()
}
...
pub fn is_blank_stream_history_directory(directory: &str) -> bool {
