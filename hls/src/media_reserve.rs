...
pub enum HlsManifestDeliveryMode {
    NormalCacheTimeline,
...
pub struct HlsLeasePlaybackCursor {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
#[must_use]
pub struct HlsPlaybackRequestToken {
    proxy_seq: u64,
    request_epoch: u64,
}
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
#[must_use]
pub enum HlsPlaybackCompletionOutcome {
    Advanced,
    Buffered,
    Duplicate,
...
impl HlsLeasePlaybackCursor {
    ...
    pub fn ready_timeline_start_proxy_seq(&self, manifest_first_proxy_seq: u64) -> u64 {
    ...
    pub fn record_request_started(&mut self, proxy_seq: u64, requested_at_ms: u64) -> HlsPlaybackRequestToken {
        let forward_seek =
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum HlsReadyMediaState {
    Ready,
    NotReady,
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct HlsReadyTimelineUnit {
    pub proxy_seq: u64,
    pub start_ms: u64,
    pub duration_ms: u64,
...
#[derive(Debug, Clone, Default, PartialEq, Eq)]
pub struct HlsReadyTimelineSnapshot {
    pub units: Arc<[HlsReadyTimelineUnit]>,
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct HlsLeaseReserveSnapshot {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum HlsLeaseReserveAvailabilityBasis {
    ReadyCacheTimeline,
    TransientOriginBacked,
}

#[derive(Clone, Copy)]
pub struct HlsLeaseReserveInput<'a> {
...
pub fn evaluate_lease_reserve(input: HlsLeaseReserveInput<'_>) -> HlsLeaseReserveSnapshot {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum HlsStartupAdmissionOriginState {
    Healthy,
    Degraded,
}
...
pub fn minimum_hls_startup_window_ms(target_duration_ms: u64, visible_playlist_duration_ms: u64) -> u64 {
...
#[derive(Clone, Copy)]
pub struct HlsStartupAdmissionInput<'a> {
    pub manifest: &'a HlsLeaseManifestSnapshot,
    pub ready_timeline: &'a HlsReadyTimelineSnapshot,
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum HlsStartupAdmissionRejection {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum HlsStartupAdmissionDecision {
    Admit,
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
#[must_use]
pub struct HlsStartupAdmissionSnapshot {
...
pub fn evaluate_startup_admission(input: HlsStartupAdmissionInput<'_>) -> HlsStartupAdmissionSnapshot {
