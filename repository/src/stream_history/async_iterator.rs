use crate::stream_history::{StreamHistoryFileReader, AsyncStreamHistoryPendingReader};
...
impl StreamHistoryStream {
    ...
    pub fn new(dir: String, time_range: TimeRange, filters: Arc<CompiledFilter>) -> Self {
