use crate::{
    ProxySessionId, TransientResourceId, TransientResourceKind, TransientResourceRef, HLS_ACCESS_LEASE_ID_PLACEHOLDER,
};
...
mod tests {
    ...
    fn rewrite(body: &str) -> crate::transient_manifest::TransientRewriteResult {
    ...
    fn rewrite_with_handoff(body: &str) -> crate::transient_manifest::TransientRewriteResult {
