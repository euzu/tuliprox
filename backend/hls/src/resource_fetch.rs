...
use tuliprox_core::utils::content_coding::{
...
pub struct HlsContentDecodingFailure {
    coding: tuliprox_core::utils::content_coding::ContentCoding,
}
...
impl HlsOriginResourceFetchError {
    ...
    pub fn projected_write_bytes(&self) -> Option<u64> {
        match self {
...
mod tests {
    ...
    use crate::{HlsBoundAccountAcquireErrorKind, HlsLogIdentity, SegmentFetchPolicy};
    use axum::http::{header, HeaderMap, HeaderValue, StatusCode};
    ...
    use tuliprox_core::utils::content_coding::{ContentCoding, ContentCodingError, ContentDecodingIoError};
    use tuliprox_parser::hls::origin_manifest::ParsedByteRange;
