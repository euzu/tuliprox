use super::{
    ...
    manifest_acceptance::{
        ...
        HlsManifestAcceptanceInput, HlsManifestAcceptanceLandscape, HlsManifestAcceptanceState,
        HlsManifestAcceptanceTrigger, HlsManifestCandidateObservation, HlsManifestCommitKind, HlsManifestCommitPlan,
        HlsManifestRecoveryCandidateIdentity, HlsManifestSegmentFingerprint, HlsManifestTimelineFingerprint,
        HlsRecoveryWorkloadBindingUpdate, HlsReducedRetryLandscapeChange, HlsResourceTimelineEvidence,
        HlsSwitchSegmentReadiness, HlsTerminalAlternativeCompatibility,
...
pub fn deterministic_conflict_receipt_is_current(session: &super::HlsSession) -> bool {
    session
        .origin_control
        .acceptance_episode
        .as_ref()
...
mod tests {
    use super::{
        ...
        deterministic_timeline_conflict_from_rejection, fetch_origin_manifest_once,
        origin_manifest_content_coding_error, origin_manifest_fetch_error_from_io_error,
        origin_manifest_fetch_error_from_request_error, request_failed_status_from_message,
        selected_manifest_candidate, FetchedOriginManifest, HlsEmergencyLiveHandoffCompatibility,
        HlsManifestCommitKind, HlsManifestCommitPlan, HlsManifestFetchSelection, HlsManifestRejectLogReason,
        HlsMediaResourceIdentity, HlsMediaResourceSemanticKey, HlsResourceReplayDecision, HlsResourceTimelineEvidence,
    ...
    use crate::recovery_timing::HlsAcceptanceDeadlineMs;
