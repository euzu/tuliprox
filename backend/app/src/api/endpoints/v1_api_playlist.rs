...
use shared::{
    ...
    model::{
        ingest_resource_value, permission::Permission, stalker::StalkerStreamKind, ConfigTargetOptions, EpgChannel,
...
mod tests {
    ...
    use crate::{
        api::model::{
            ...
            PlaylistStorageState, RecordingQueue, SharedStreamManager,
        },
        model::{
