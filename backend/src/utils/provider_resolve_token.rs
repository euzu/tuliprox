...
pub fn decode_provider_resolve_token(
    secret: &[u8; 16],
    encoded: &str,
) -> Result<ProviderResolveToken, TuliproxError> {
...
mod tests {
    use super::{
        decode_provider_resolve_token, encode_provider_resolve_playlist_item_token,
        ProviderResolvePlaylistItemToken, ProviderResolveToken,
    };
