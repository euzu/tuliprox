use super::{
    prepared_terminal_bundle::HlsPreparedTerminalBundleKey, session_store::HlsSessionIncarnation,
    runtime_custom_tail::{HlsRuntimeCustomTailAssetIdentity, HlsRuntimeCustomTailReason},
    terminal_commit::HlsTerminalAssetRevisionGuard, HlsAccessLeaseId, ProxySessionId,
};
...
pub(crate) struct HlsTerminalPendingOwnerKey {
...
impl HlsTerminalPendingOwnerKey {
    ...
    fn bundle_asset_is_current_if_changed(
        &self,
        current: &Self,
...
#[must_use]
pub(crate) enum HlsTerminalPendingRegistration {
    Scheduled,
    AlreadyOwned,
    Superseded,
    CapacityExceeded,
...
pub(crate) struct HlsTerminalPendingCoordinator {
...
#[derive(Clone)]
pub(crate) struct HlsTerminalPendingOwnership {
...
impl HlsTerminalPendingOwnership {
    ...
    pub(crate) fn latest_safe_commit_at_ms(&self) -> u64 { self.key.latest_safe_commit_at_ms }
...
mod tests {
    use super::*;
    use crate::api::model::hls_cache::terminal_tail::HlsTerminalAssetIdentity;
