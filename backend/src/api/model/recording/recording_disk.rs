...
pub fn would_fit_on_disk(
    ...
    if candidate_charge <= headroom {
        DiskAdmission::Ok {
            headroom_after: headroom - candidate_charge,
        }
    } else {
    ...
    V: super::recording_quota::QuotaRecordingTaskView,
{
    ...
    for task in tasks {
        ...
        if matches!(task.state(), crate::api::model::download::DownloadState::Downloading) {
...
mod tests {
    ...
    fn downloading(reserved: u64, measured: u64) -> T {
        T {
            ...
            recording: Some(make_meta(reserved, measured)),
        }
    }
    ...
    fn active_reservations_count_only_downloading() {
        ...
        let tasks = vec![
            ...
            T {
                ...
                recording: Some(make_meta(500, 0)),
            },
            T {
                state: DownloadState::Completed,
                recording: Some(make_meta(0, 4000)),
            },
        ];
