...
impl From<&RecordingConfig> for RecordingConfigDto {
    fn from(instance: &RecordingConfig) -> Self {
        Self {
            ...
            default_pre_roll_secs: if instance.default_pre_roll_secs == 0 { None } else { Some(instance.default_pre_roll_secs) },
            max_pre_roll_secs: instance.max_pre_roll_secs,
            default_post_roll_secs: if instance.default_post_roll_secs == 0 { None } else { Some(instance.default_post_roll_secs) },
