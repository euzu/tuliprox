use crate::stream_history::{
    read_and_verify_file_magic, read_framed, write_file_magic, write_framed, writer::apply_retention, BlockHeaderBody,
    CompressionKind, FileHeaderBody, RecordEncodingKind, BLOCK_MAGIC, CONTAINER_FORMAT_VERSION,
    SOURCE_KIND_STREAM_HISTORY,
};
use log::{info, warn};
...
mod tests {
    use super::*;
    use crate::stream_history::{
        read_and_verify_file_magic, read_framed, serialize_named, write_block_magic, writer::StreamHistoryWriter,
        CompressionKind,
    };
    ...
    use tuliprox_core::model::{StreamHistoryConfig, StreamHistoryRecord};
    ...
    fn write_test_pending(dir: &Path, day: &str, records: &[StreamHistoryRecord]) -> PathBuf {
        use crate::stream_history::{
            BlockHeaderBody, CompressionKind, RecordEncodingKind, CONTAINER_FORMAT_VERSION, SOURCE_KIND_STREAM_HISTORY,
        };
