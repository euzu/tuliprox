...
use shared::{
    defaults::{
        ...
        default_tmdb_cache_duration_days, default_tmdb_language, default_tmdb_match_threshold,
...
impl From<&MetadataLogConfig> for MetadataLogConfigDto {
    fn from(instance: &MetadataLogConfig) -> Self {
        Self { queue_interval: instance.queue_interval.clone(), progress_interval: instance.progress_interval.clone() }
    }
}
