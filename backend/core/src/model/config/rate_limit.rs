...
impl From<&RateLimitConfigDto> for RateLimitConfig {
    fn from(dto: &RateLimitConfigDto) -> Self {
        Self { enabled: dto.enabled, period_millis: dto.period_millis, burst_size: dto.burst_size }
    }
}

impl From<&RateLimitConfig> for RateLimitConfigDto {
    fn from(instance: &RateLimitConfig) -> Self {
        Self { enabled: instance.enabled, period_millis: instance.period_millis, burst_size: instance.burst_size }
    }
}
