//! Parsing a single HTTP `Range` header.
//!
//! Pure header arithmetic; both the streaming layer and the HLS proxy serve
//! ranged responses from it.
...
pub fn resolve_single_byte_range(range_header: Option<&HeaderValue>, full_size: u64) -> SingleByteRange {
...
mod tests {
    ...
    fn absent_invalid_utf8_and_unknown_units_are_ignored() {
        ...
        assert_eq!(resolve_single_byte_range(Some(&header("items=0-1")), 10), SingleByteRange::Full);
    }
}
