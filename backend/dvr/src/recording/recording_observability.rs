...
mod tests {
    ...
    fn counter_wire_names_are_stable() {
        ...
        assert_eq!(Counter::UnsafePathRejection.wire_name(), "recording_unsafe_path_rejection_total");
        assert_eq!(Counter::RetentionCleanup.wire_name(), "recording_retention_cleanup_total");
        assert_eq!(Counter::NotificationAttempt.wire_name(), "recording_notification_attempt_total");
        assert_eq!(Counter::NotificationFailure.wire_name(), "recording_notification_failure_total");
    }
